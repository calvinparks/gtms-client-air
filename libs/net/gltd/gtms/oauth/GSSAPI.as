...
package net.gltd.gtms.oauth
{
	 ...
	 */
	public class GSSAPI extends SASLAuth
	{
		public static const MECHANISM:String = "GSSAPI";
		 ...
		 */
		public function GSSAPI( connection:XMPPConnection )
		{
			...
			*/
			...
			req.setNamespace( GSSAPI.NS );
			req.@mechanism = GSSAPI.MECHANISM;
